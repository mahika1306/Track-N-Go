  ...
  setJourneyDetails({
    ...
    const addDataToFirestore = async () => {
      try {
        ...
        const { sourceCoordinates, destinationCoordinates } = journeyDetails;
        

        // Add data to Firestore
        await setDoc(doc(firestore, 'busDetails', busDetails.plateNumber), busDetails);
        await setDoc(doc(firestore, 'journeyDetails', journeyDetails.journeyPlateId),{
          ...journeyDetails,
      sourceCoordinates,
      destinationCoordinates,
